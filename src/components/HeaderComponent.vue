  ...
  <header
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a
        ...
        <img
          src="../../public/NiceAdmin/assets/img/logo.png"
          alt="" />
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img
                  src="../../public/NiceAdmin/assets/img/messages-1.jpg"
                  alt=""
            ...
            <li class="message-item">
              <a href="#">
                <img
                  src="../../public/NiceAdmin/assets/img/messages-2.jpg"
                  alt=""
                  class="rounded-circle" />
                <div>
                  <h4>Anna Nelson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img
                  src="../../public/NiceAdmin/assets/img/messages-3.jpg"
                  alt=""
                  class="rounded-circle" />
                <div>
                  <h4>David Muldon</h4>
